...
skyline = MWAS_skylineNMR(metabo_SE, MWAS_BMI, ref_sample = "QC1")
```
<br>

## NMR metabolite assignment using STOCSY
<p style="font-size:110%"> We then used STOCSY to assign the unknown NMR signals associated with BMI. An illustrative example using δ 1.04 as driver signal is shown below. </p>
...
indicate pathway class. <br><br> </p>
